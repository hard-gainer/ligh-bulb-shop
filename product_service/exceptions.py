...
PRODUCT_SKU_ALREADY_EXISTS_DETAIL = "Product SKU already exists"
...
def product_sku_already_exists(sku: str) -> HTTPException:
    return HTTPException(
        status_code=409,
        detail=f"{PRODUCT_SKU_ALREADY_EXISTS_DETAIL}: {sku}",
    )
